...
class DbEngine:
    def __init__(self):
        self.url = f"{settings.USERS_DB_ENGINE}://{settings.USERS_DB_USER}:{settings.USERS_DB_PASSWORD}@{settings.USERS_DB_HOST}:{settings.USERS_DB_PORT}/{settings.USERS_DB_NAME}"
